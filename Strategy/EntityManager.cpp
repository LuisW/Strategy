...
EntityID EntityManager::newPlayer()
{
	...
	entityAddComponent(ent, new CameraComponent(ent, "Cam", 60.0f, 4.0f/3.0f, 0.1f, 10000.0f, glm::vec3(819.3f, 625.0f, 819.3f), glm::angleAxis(0.0f,glm::vec3(0.0f,1.0f,0.0f))));
